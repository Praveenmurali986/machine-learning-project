...
DataValidationArtifact,ModelEvaluationArtifact,ModelTrainerArtifact,ModelPusherArtifact
...
Experiment=namedtuple('Experiment',['experiment_id',
...
class Pipeline(Thread):
    ...
    def start_data_validation(self,data_insgestion_artifact:DataIngestionArtifact)->DataValidationArtifact:
        try:
            data_validation=DataValidation(data_validation_config=self.config.get_data_validation_config(),data_ingestion_artifact=data_insgestion_artifact)
    ...
    def run_pipeline(self):
        try:
            ...
            Pipeline.experiment=Experiment(experiment_id=experiment_id,
                                           ...
                                           stop_time=None,
                                           execution_time=None,
                                           message='Pipeline start running',
        ...
        try:
            if Pipeline.experiment.experiment_id is not None:
                ...
                if os.path.exists(Pipeline.experiment_file_path):
                    ...
                    experiment_report.to_csv(Pipeline.experiment_file_path,mode='w',header=True,indel=False)
            else:
