...
class ModelEvaluation:
    ...
    def update_evaluation_report(self,model_evaluation_artifact:ModelEvaluationArtifact):
        try:
            ...
            logging.info(f'previous eval content : {model_eval_content}')
            ...
            logging.info(f'updatd eval result : {model_eval_content}')
    ...
    def initiate_model_evaluation(self):
        try:
            trianed_model_file_path=self.model_trainer_artifact.trained_model_file_path
            trained_model_object=load_obj(file_path=trianed_model_file_path)
            ...
            logging.info(f'droping target column from test ant train dataframe')
            ...
            logging.info(f'droping target column completed.')
            ...
            if model is None:
                ...
                model_evaluation_artifact=ModelEvaluationArtifact(
                                                                ...
                                                                evaluated_model_path=trianed_model_file_path
                )
            ...
            logging.info(f'model evaluation completed. modef etric artifact : {metric_info_artifact}')
            ...
            if metric_info_artifact.index_number==1:
                ...
                logging.info(f'trained model is no better tham existing model hence not accepting trained model')
                model_evaluation_artifact=ModelEvaluationArtifact(
                                                is_model_accepted=False,
                                                evaluated_model_path=trianed_model_file_path
                                                )
    ...
    def __del__(self):
        logging.info(f'{"="*20} model evaluation log completed')