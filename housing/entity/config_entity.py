...
DataIngestionConfig=namedtuple('DataIngestionCongig',["dataset_download_url","tgz_download_dir","raw_data_dir","ingested_train_dir","ingested_test_dir"])
...
ModelTrainerConfig=namedtuple('ModelTrainerConifg',"trained_model_file_path","base_accuracy")
